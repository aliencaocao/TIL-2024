...
GLOBAL_INLINE void mish_fwd_func(scalar_t &out, const scalar_t &inp)
{
    out = inp * tanh(
...
template <typename scalar_t>
GLOBAL_INLINE void mish_bwd_func(scalar_t &grad_inp, const scalar_t &inp, const scalar_t &grad_out)
{
...
template <>
GLOBAL_INLINE void mish_fwd_func(c10::Half &out, const c10::Half &inp)
{
    float res;
...
template <>
GLOBAL_INLINE void mish_bwd_func(c10::Half &grad_inp, const c10::Half &inp, const c10::Half &grad_out)
{
    float res;
