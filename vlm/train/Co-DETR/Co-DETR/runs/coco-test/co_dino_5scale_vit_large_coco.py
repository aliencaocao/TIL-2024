    ...
    dict(
        ...
        transforms=[
            dict(
                ...
                var_limit=(500, 5000),
                per_channel=True),
            dict(type='ISONoise', p=1.0, color_shift=(0.02, 0.07)),
            dict(type='MultiplicativeNoise', p=1.0, multiplier=(0.9, 1.1)),
        ...
        pipeline=[
            ...
            dict(
                ...
                transforms=[
                    ...
                    dict(type='RandomGamma', p=0.2),
                    dict(
                        type='ImageCompression', p=0.8, quality_range=(25, 75))
                ],
                bbox_params=dict(
                    type='BboxParams',
                    format='pascal_voc',
...
model = dict(
    ...
    backbone=dict(
        ...
        init_cfg=dict(
            type='Pretrained',
            checkpoint=
            '/root/TIL-2024/vlm/train/Co-DETR/co_dino_5scale_vit_large_coco.pth'
        )),
    neck=dict(
        type='SFP',
        in_channels=[1024],
